...
export const HERO_CONTENT = {
  badge: 'Trusted by 500+ Top Brand',
  title: '우리 제품이 "원하는 채널"\n정확히 찾아드립니다.',
...
export const TESTIMONIALS: Testimonial[] = [
  {
    quote: "CelebLife와 진행한 캠페인은 단순 매출 상승에 그치지 않고, 브랜드 인지도까지 함께 끌어올리는 성과를 만들었습니다. 짧은 기간 안에 제품을 시장에 각인시키는 데 매우 효과적이었어요.",
    author: "김OO",
    role: "색조 뷰티 브랜드 R사",
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `뷰티
스킨케어(클렌징/각질·모공/진정/미백·탄력)
바디·헤어, 선케어, 색조(베이스/립), 이너뷰티
...
리빙
홈/주방용품(정리·수납, 조리도구/주방잡화)
생활·청소(세제/청소템, 위생·수납 솔루션)
인테리어 소품(패브릭/데코, 조명 등)
라이프스타일 소모품(향/디퓨저, 데일리 케어 아이템)

다만 저희는 단순히 “셀럽 리스트”를 붙이는 방식이 아니라,
제품의 핵심 USP, 타겟 톤·팬덤 반응, 가격대, 구매성향(반복구매/선물/충동구매 등)까지 함께 보고, 해당 제품에서 성공 확률이 높은 후보만 압축해 전달 드립니다.`
  },
  {
